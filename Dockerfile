...
COPY --from=builder $TARGET_FOLDER/ms-cursos-0.0.1-SNAPSHOT.jar .
...
# CMD sleep 10 && java - jar ms-cursos-0.0.1-SNAPSHOT.jar -> necesario para sincronizacion en AWS-ECS
